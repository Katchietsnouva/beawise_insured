  ...
  Widget build(BuildContext context) {
    final platforms = [
      _PlatformData(
        ...
        false,
        null,
        '/downloads/v1.0.1-armeabi-v7a-release.apk',
        // 'https://github.com/Katchietsnouva/beawise_insured/blob/main/web/downloads/v1.0.1-arm64-v8a-release.apk',
      ),
      _PlatformData(
        'iOS / iPadOS',
        'iPhone & iPad\niOS 15 or later',
          ...
          content: Column(
            ...
            children: [
              _archOption(
                ...
                '/downloads/v1.0.1-arm64-v8a-release.apk',
                cs,
              ),
              ...
              _archOption(
                ...
                '/downloads/v1.0.1-x86_64-release.apk',
                cs,
              ),
            ],
          ),
