...
class _MotorSaveScreenState extends ConsumerState<MotorSaveScreen> {
  ...
  void initState() {
    ...
    _searchController.addListener(() {
      ...
      print('here is tje passed  selectedQuote :  ${widget.selectedQuote}');
    });
    ...
    try {
      ...
      final request = MotorSaveRequest(
        ...
        policy: MotorPolicy(
          ...
          vehicleClass: selectedClass ?? 'Motor', // default // from choice
          subClass: subClassCtrl.text.isNotEmpty
              ? subClassCtrl.text
              : 'Private', // default // from choice
          // totalBasic: double.tryParse(quote.) ?? 0,
          totalBasic: 40000,
