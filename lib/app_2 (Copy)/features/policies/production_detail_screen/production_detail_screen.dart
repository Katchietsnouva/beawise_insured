...
class ProductionDetailScreen extends StatelessWidget {
  ...
  const ProductionDetailScreen({super.key, required this.entry});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: CustomText('Production Details', type: CustomTextType.header),
            ...
            children: [
              ...
              Center(
                child: CustomAdvancedButton(
                  ...
                  onPressed: () {
                    // Navigate to renewal flow if needed
                  },
                ),
              ),
            ],
